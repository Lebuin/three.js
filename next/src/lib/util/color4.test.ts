...
describe('color', () => {
  function expectColorToBe(color4: Color4, color: Color, opacity: number) {
  ...
  test('should construct a color from a 6-hex number', () => {
    ...
    const reference = new Color(0x123456);
    expectColorToBe(color, reference, 1);
  });
  ...
  test('should construct a color from a rgb string', () => {
    ...
    const reference = new Color('rgb(12, 34, 56)');
    expectColorToBe(color, reference, 1);
  });
  ...
  test('should construct a color from a hsl string', () => {
    ...
    const reference = new Color('hsl(120, 100%, 50%)');
    expectColorToBe(color, reference, 1);
  });
